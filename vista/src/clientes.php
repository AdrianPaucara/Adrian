            ...
            <div class="col-md-12">
                ...
                <form action="" method="post" autocomplete="off" id="formulario">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label for="telefono" class="text-dark font-weight-bold">Cedula de identidad o Nit</label>
                                <input type="number" placeholder="Ingrese ci o nit" name="telefono" id="telefono" class="form-control">
                                <input type="hidden" name="id" id="id">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="direccion" class="text-dark font-weight-bold">Telefono</label>
                                <input type="text" placeholder="Ingrese telefono" name="direccion" id="direccion" class="form-control">
                            </div>
                        </div>
