                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="codigo" class=" text-dark font-weight-bold">Descripcion</label>
                                        <input type="text" placeholder="Ingrese la descripcion del producto" name="codigo" id="codigo" class="form-control">
