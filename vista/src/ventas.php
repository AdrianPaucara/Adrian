            ...
            <div class="card-body">
                <form method="post">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Cedula de identidad o Nit</label>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-5">
                        <div class="form-group">
                            <label for="producto">Descripcion o Nombre</label>
                            <input id="producto" class="form-control" type="text" name="producto" placeholder="Ingresa la descripcion o nombre">
